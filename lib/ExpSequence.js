...
module.exports = ExpSequence = Proteus.Class.derive({
    ...
    init: function (/*patterns*/) {
        this.reset();
        Proteus.slice(arguments).forEach(this.addPattern, this);
    },
    
    /**
     * @property patterns
     * @type {array[String|RegExp|ExpSequence]}
     * @default undefined
     */
    ...
    addPattern: function (pattern) {
        var pats = this.patterns || (this.patterns = []);
    ...
    test: function (txt) {
        ...
        result = pats.every(collectCaptures.bind(this));
    ...
    exec: function (txt) {
        var pats = this.patterns;
        this.scanner = txt;
        return pats.every(collectCaptures.bind(this)) ?
                this.captures : null;
    },
